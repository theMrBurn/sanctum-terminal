...
KIND_PROPS = {
    ...
    "buttress":        {"scale": [2.5, 2.5, 6.0],  "color": [1.00, 1.00, 1.00], "emissive": 0.0},
    "boulder":         {"scale": [5.0, 4.4, 3.1],  "color": [1.00, 1.00, 1.00], "emissive": 0.0},
    ...
    "bone_pile":       {"scale": [0.6, 0.6, 0.3],  "color": [1.00, 1.00, 1.00], "emissive": 0.0},
    "grass_tuft":      {"scale": [0.3, 0.3, 0.25], "color": [1.00, 1.00, 1.00], "emissive": 0.0},
    "rubble":          {"scale": [1.0, 1.0, 0.5],  "color": [1.00, 1.00, 1.00], "emissive": 0.0},
    "leaf_pile":       {"scale": [0.5, 0.5, 0.1],  "color": [1.00, 1.00, 1.00], "emissive": 0.0},
    "twig_scatter":    {"scale": [0.6, 0.4, 0.05], "color": [1.00, 1.00, 1.00], "emissive": 0.0},
    "cave_gravel":     {"scale": [0.2, 0.2, 0.05], "color": [1.00, 1.00, 1.00], "emissive": 0.0},
    ...
    "rat":             {"scale": [1.5, 1.5, 1.5],   "color": [1.00, 1.00, 1.00], "emissive": 0.0},
